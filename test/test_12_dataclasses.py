...
#     test_data_list = (
#         ([-128, 127], ["GDT_Int8"], "GDT_Int8"),
#         ([-128, 127], ["GDT_Int16"], "GDT_Int16"),
#         ([-128, 127], ["GDT_UInt16"], "GDT_Int16"),
#         ([0.333, 1.777], ["GDT_Float64"], "GDT_Float64"),
#         ([3 * 10**40, 1], ["GDT_Float64"], "GDT_Float64"),
#         ([3 * 10**37, 1], ["GDT_Float32"], "GDT_Float32"),
#         ([-128, 127], ["GDT_Int8", "GDT_Byte"], "GDT_Int8"),
#         ([0, 127], ["GDT_Int8"], "GDT_Int8"),
#         ([0, 255], ["GDT_Byte"], "GDT_Byte"),
#         ([0, 127], ["GDT_Byte"], "GDT_Int8"),
#         ([0, 32767], ["GDT_Int16"], "GDT_Int16"),
#         ([0, 32767], ["GDT_UInt16"], "GDT_UInt16"),
#     )
#     for current_test_data in test_data_list:
#         print(current_test_data)
#         list_of_numbers = current_test_data[0]
...
#             user_defined_minimum_gdal_type=minimum_gdal_type[0],
#         )
#         min_data_type_assertion = current_test_data[2]
#         assert min_data_type == min_data_type_assertion, (
#             f"min_data_type: {min_data_type} != min_data_type_assertion: {min_data_type_assertion} for test case:\n{current_test_data}"
...
#     test_data_list = (
#         ([-128, 130], ["GDT_Int8"], "GDT_Int16"),
#         ([-128, 127], ["GDT_Byte"], "GDT_Int16"),
#         ([3 * 10**40, 1], ["GDT_Int8"], "GDT_Float64"),
#         ([3 * 10**40, 1], ["GDT_Int16"], "GDT_Float64"),
#         ([3 * 10**40, 1], ["GDT_UInt16"], "GDT_Float64"),
#         ([3 * 10**40, 1], ["GDT_Int64"], "GDT_Float64"),
#         ([3 * 10**37, 1], ["GDT_Int8"], "GDT_Float32"),
#         ([3 * 10**37, 1], ["GDT_Int64"], "GDT_Float32"),
#     )
#     for current_test_data in test_data_list:
#         print(current_test_data)
#         list_of_numbers = current_test_data[0]
